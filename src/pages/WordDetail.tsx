...
import type {Word, WordDefinition, Example, VerbForm, WordDefinitionExample} from '../types';
...
const WordDetail: React.FC = () => {
  ...
  const handleEditVerbForm = (verbForm: VerbForm) => {
    // Make sure we have at least one content item with at least one form
  ...
  const handleSaveVerbForm = async () => {
    ...
    try {
      ...
      if (editingVerbFormId) {
        ...
        // Update the word state with the updated verb form
        setWord({
          ...word,
        ...
        // Update the word state with the new verb form
        setWord({
          ...word,
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <TextField
                ...
                onChange={(e) => handleArrayChange(e, 'anagrams')}
                    ...
                    <Box key={contentIndex} sx={{ mb: 3 }}>
                      ...
                      {content.forms && content.forms.map((form, formIndex) => (
                        <Box key={formIndex} sx={{ display: 'flex', mb: 1 }}>
                          <Box sx={{ width: '50%' }}>
                            <Typography><strong>Singular:</strong> {form.singular}</Typography>
                          </Box>
                          <Box sx={{ width: '50%' }}>
            ...
            {definitionFormData.others?.map((other, otherIndex) => (
              <Box key={otherIndex} sx={{ mt: 2, p: 2, border: '1px solid #e0e0e0', borderRadius: 1 }}>
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    const updatedOthers = [...(definitionFormData.others || [])];
                    updatedOthers[otherIndex] = {...updatedOthers[otherIndex], meaning: e.target.value};
                    setDefinitionFormData({...definitionFormData, others: updatedOthers});
                  }}
                />
                  ...
                  <Box key={exampleIndex} sx={{ mt: 1, p: 1, bgcolor: '#f5f5f5', borderRadius: 1 }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <IconButton 
                        ...
                        onClick={() => {
                          ...
                          updatedOthers[otherIndex] = {...updatedOthers[otherIndex], examples: updatedExamples};
                          setDefinitionFormData({...definitionFormData, others: updatedOthers});
                        }}
                      >
                    ...
                    <TextField
                      ...
                      onChange={(e) => {
                        const updatedOthers = [...(definitionFormData.others || [])];
                        const updatedExamples = [...updatedOthers[otherIndex].examples];
                        updatedExamples[exampleIndex] = {...updatedExamples[exampleIndex], phrase: e.target.value};
                        updatedOthers[otherIndex] = {...updatedOthers[otherIndex], examples: updatedExamples};
                        setDefinitionFormData({...definitionFormData, others: updatedOthers});
                      }}
                    />
                    ...
                    <TextField
                      ...
                      onChange={(e) => {
                        const updatedOthers = [...(definitionFormData.others || [])];
                        const updatedExamples = [...updatedOthers[otherIndex].examples];
                        updatedExamples[exampleIndex] = {...updatedExamples[exampleIndex], translation: e.target.value};
                        updatedOthers[otherIndex] = {...updatedOthers[otherIndex], examples: updatedExamples};
                        setDefinitionFormData({...definitionFormData, others: updatedOthers});
                      }}
                    />
                ...
                <Button 
                  ...
                  onClick={() => {
                    const updatedOthers = [...(definitionFormData.others || [])];
                    const updatedExamples = [...updatedOthers[otherIndex].examples, { phrase: '', translation: '' }];
                    updatedOthers[otherIndex] = {...updatedOthers[otherIndex], examples: updatedExamples};
                    setDefinitionFormData({...definitionFormData, others: updatedOthers});
                  }}
                >
            ...
            {verbFormFormData.content?.map((contentItem, contentIndex) => (
              <Box key={contentIndex} sx={{ mt: 2, p: 2, border: '1px solid #e0e0e0', borderRadius: 1 }}>
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    const updatedContent = [...(verbFormFormData.content || [])];
                    updatedContent[contentIndex] = {...updatedContent[contentIndex], title: e.target.value};
                    setVerbFormFormData({...verbFormFormData, content: updatedContent});
                  }}
                />
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <IconButton 
                        ...
                        onClick={() => {
                          ...
                          updatedContent[contentIndex] = {...updatedContent[contentIndex], forms: updatedForms};
                          setVerbFormFormData({...verbFormFormData, content: updatedContent});
                        }}
                      >
                        <DeleteIcon fontSize="small" />
                      ...
                      <Grid item xs={6}>
                        <TextField
                          ...
                          onChange={(e) => {
                            const updatedContent = [...(verbFormFormData.content || [])];
                            const updatedForms = [...updatedContent[contentIndex].forms];
                            updatedForms[formIndex] = {...updatedForms[formIndex], singular: e.target.value};
                            updatedContent[contentIndex] = {...updatedContent[contentIndex], forms: updatedForms};
                            setVerbFormFormData({...verbFormFormData, content: updatedContent});
                          }}
                        />
                      ...
                      <Grid item xs={6}>
                        <TextField
                          ...
                          onChange={(e) => {
                            const updatedContent = [...(verbFormFormData.content || [])];
                            const updatedForms = [...updatedContent[contentIndex].forms];
                            updatedForms[formIndex] = {...updatedForms[formIndex], plural: e.target.value};
                            updatedContent[contentIndex] = {...updatedContent[contentIndex], forms: updatedForms};
                            setVerbFormFormData({...verbFormFormData, content: updatedContent});
                          }}
                        />
                ...
                <Button 
                  ...
                  onClick={() => {
                    const updatedContent = [...(verbFormFormData.content || [])];
                    const updatedForms = [...updatedContent[contentIndex].forms, { singular: '', plural: '' }];
                    updatedContent[contentIndex] = {...updatedContent[contentIndex], forms: updatedForms};
                    setVerbFormFormData({...verbFormFormData, content: updatedContent});
                  }}
                >
